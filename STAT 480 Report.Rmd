...
youtube %>% 
  ...
  labs(x = "Date", 
       ...
       color = "Category",
       caption = "Figure: Observing the top five categories") +
...
youtube %>%
  ...
  labs(x = "Categories", 
       ...
       caption = "Figure: Considering the views from the last day trending") +
...
youtube %>%
  ...
  labs(x = "Total Comments", 
       ...
       caption = "Figure: Considering the comments from the last day trending") +
  scale_y_continuous(labels = scales::comma)
```
