...
youtube %>% 
  ...
  labs(x = "Length of Title", 
       ...
       caption = "Figure 7: Calculated with distinct video ID's") 
```
...
youtube %>% 
  ...
  labs(x = "Number of Words", 
       ...
       caption = "Figure 8: Calculated with distinct video ID's")
```
...
youtube %>% 
  ...
  labs(x = "Proportion of Capital Letters in Title", 
       ...
       caption = "Figure 9: Calculated with distinct video ID's")
```
